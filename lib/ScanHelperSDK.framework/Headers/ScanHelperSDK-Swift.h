...
/// @discussion
/// None
- (void)scanLimit:(UIView * _Nonnull)bottomView SWIFT_AVAILABILITY(ios,introduced=12.0);
/// @method scanUnrestrained:
/// @param fullView
/// A view that is the same size as the parent view.
/// @discussion
/// None
- (void)scanUnrestrained:(UIView * _Nonnull)fullView SWIFT_AVAILABILITY(ios,introduced=12.0);
/// @method scanCaptureOutput:
/// @param brightnessValue
/// A brightness value.
/// @discussion
/// None
- (void)scanCaptureOutput:(double)brightnessValue SWIFT_AVAILABILITY(ios,introduced=12.0);
/// @method scanMetadataOutput:
/// @param values
/// An array of scan results.
/// @discussion
/// None
- (void)scanMetadataOutput:(NSArray<ScanResult *> * _Nonnull)values SWIFT_AVAILABILITY(ios,introduced=12.0);
@end
